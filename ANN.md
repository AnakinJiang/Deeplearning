...
![](images/ANN/ann_10.jpg)

我们设计出了类似于神经元的神经网络，效果如下：

![](images/ANN/ann_11.png)
...
上面进行的讨论中只是将特征矩阵中的一行（一个训练实例）给了神经网络，我们需要将整个训练集都给我们的神经网络算法来学习模型。
...
\end{bmatrix}
$$
我们可以得到$a=g(\theta \cdot X)$ ，相对于使用循环来编码，利用向量化的方法会使得计算更为简便。以上面的神经网络为例，试着计算第二层的值：

![](images/ANN/ann_14.png)

![](images/ANN/2e17f58ce9a79525089a1c2e0b4c0ccc.png)

我们令 ${{z}^{\left( 2 \right)}}={{\theta }^{\left( 1 \right)}}x$，则 ${{a}^{\left( 2 \right)}}=g({{z}^{\left( 2 \right)}})$ ，计算后添加 $a_{0}^{\left( 2 \right)}=1$。 计算输出的值为：

![](images/ANN/43f1cb8a2a7e9a18f928720adc1fac22.png)
...
![](images/ANN/809187c1815e1ec67184699076de51f2.png)
...
![](images/ANN/6d652f125654d077480aadc578ae0164.png)



![](images/ANN/f75115da9090701516aa1ff0295436dd.png)
...
![](images/ANN/aa27671f7a3a16545a28f356a2fb98c0.png)
...
![](images/ANN/57480b04956f1dc54ecfc64d68a6b357.jpg)

下图的神经元（三个权重分别为-10，20，20）可以被视为作用等同于逻辑或（**OR**）：

![](images/ANN/7527e61b1612dcf84dadbcf7a26a22fb.jpg)

下图的神经元（两个权重分别为 10，-20）可以被视为作用等同于逻辑非（**NOT**）：

![](images/ANN/1fd3017dfa554642a5e1805d6d2b1fa6.jpg)
...
![](images/ANN/f3236b14640fa053e62c73177b3474ed.jpg)

![](D:/ECNU/mechine%20learning/Coursera-ML-AndrewNg-Notes-master/Coursera-ML-AndrewNg-Notes-master/images/685180bf1774f7edd2b0856a8aae3498.png)

神经网络算法的输出结果为四种可能情形之一：



![](D:/ECNU/mechine%20learning/Coursera-ML-AndrewNg-Notes-master/Coursera-ML-AndrewNg-Notes-master/images/5e1a39d165f272b7f145c68ef78a3e13.png)